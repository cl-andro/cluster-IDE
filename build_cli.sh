...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/ClusterFamily/versions/refs/heads/master"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/ClusterFamily/cluster-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/ClusterFamily/cluster/releases"
fi
