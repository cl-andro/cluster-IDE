...
# Getting Started with clusterIDE

This guide will help you get started with clusterIDE.
...
clusterIDE can be installed on Windows, macOS, and Linux. Visit the [download page](https://clusterIDE.com/#install) for installation instructions.

## <a id="first-steps"></a>First Steps

After installing clusterIDE, here are some first steps to get started:
...
clusterIDE works just like Visual Studio Code, with a few differences:
...
- Explore the [documentation](https://github.com/cl-andro/cluster-IDE/blob/master/docs/index.md) for more details
- Join the [community](https://github.com/cl-andro/cluster-IDE/discussions) to ask questions and share tips
- Contribute to the [project](https://github.com/cl-andro/cluster-IDE/blob/master/CONTRIBUTING.md) if you're interested
